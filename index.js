...
fake = `𝗢𝘄𝗻𝗲𝗿 : ${fakeyoi}\n☁️︎ 𝗣𝗿𝗲𝗳𝗶𝘅 :「 ${prefixStatus ? "Multi Prefix" : "No Prefix"} 」`;
...
const daftar1 = `Hi ${pushname} ${ucapanWaktu} \n\nBefore Using the Bot Verify First `
       const daftar2 = '```Click the button below to verify \n ᴍᴏɴsᴛᴇʀ ʙᴏᴛ```'
       const daftar3 = [
          {
            buttonId: `verify`,
            buttonText: {
...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/E6kGrmOhmo9FtNvonhrjy1', "groupName": `Akbar Bot Inc.`, "footerText": "*_ ᴍᴏɴsᴛᴇʀ ʙᴏᴛ_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":` ᴍᴏɴsᴛᴇʀ ʙᴏᴛ`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
             res = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*AKBAR*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             xeon.relayWAMessage(res)
        }
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `AKBAR`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/919677331878?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n ᴍᴏɴsᴛᴇʀ ʙᴏᴛ. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"mediaType": "2",
"thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
"mediaUrl": "https://www.youtube.com/channel/UC55ezJ-mYFw0x_XQ5nFq0Ag",
...
await xeon.setStatus(`on ${uptime}`).catch((_) => _);
...
*Thank you for registering in the  ᴍᴏɴsᴛᴇʀ ʙᴏᴛ Database*
...
*「  ᴍᴏɴsᴛᴇʀ ʙᴏᴛ 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'Akbar', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*sᴜᴄᴄᴇssғᴜʟʟʏ ʀᴇɢɪsᴛᴇʀᴇᴅ ᴍᴏɴsᴛᴇʀ ʙᴏᴛ*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Hi ${pushname} 👋\n\nIF YOU ARE USING MOD WHATSAPP & BUTTONS DOESNT SHOW WATCH VIDEO https://youtube.com/shorts/3TlR5wWlJdg?feature=share, TYPE #allmenu`
 ...
 ⎇ ɢʀᴏᴜᴩ ᴄʜᴀᴛꜱ : ${groups.length} 
 ⎇︎ ᴩʀɪᴠᴀᴛᴇ ᴄʜᴀᴛꜱ : ${privat.length}
 ⎇ ᴛᴏᴛᴀʟ ᴄʜᴀᴛꜱ : ${totalChat.length}
 ⎇ ꜱᴩᴇᴇᴅ : ${latensie.toFixed(4)} _Second_
 ⎇ ᴀᴄᴛɪᴠᴇ : ${runtime(process.uptime())}
 ⎇︎ ᴩʟᴀᴛꜰᴏʀᴍ : ${os.platform()}`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
⎇ ꜱᴩᴇᴇᴅ : ${latensie.toFixed(4)} _Second_
⎇ ᴀᴄᴛɪᴠᴇ : ${runtime(process.uptime())}
⎇︎ ᴩʟᴀᴛꜰᴏʀᴍ : ${os.platform()}
${readmore}

ↈ  *LINK :* 
Subscribe my YouTube channel guys
https://www.youtube.com/channel/UC55ezJ-mYFw0x_XQ5nFq0Ag
...
> ☁️ ${prefix}autotype on|off
> ☁️ ${prefix}autoread gc in / gc off
> ☁️ ${prefix}autovn on|off
> ☁️ ${prefix}anticall on|off
> ☁️ ${prefix}getcaption
> ☁️ ${prefix}bugcatalog
> ☁️ ${prefix}buggc id grup
> ☁️ ${prefix}okvirtex
> ☁️ ${prefix}on
> ☁️ ${prefix}status
> ☁️ ${prefix}setthumb
...
> ☁️ ${prefix}setfakeimg
> ☁️ ${prefix}setreply
> ☁️ ${prefix}hacked name
> ☁️ ${prefix}setprefix
> ☁️ ${prefix}mode /public-self/
> ☁️ ${prefix}term <code>
> ☁️ ${prefix}eval <code>
> ☁️ ${prefix}colongsw reply
 > ☁️ ${prefix}addvn <reply audio with name>
 > ☁️ ${prefix}delvn <audio name>
 > ☁️ ${prefix}vnlist
 > ☁️ ${prefix}addsticker <reply sticker with name>
 > ☁️ ${prefix}delsticker <sticker name>
 > ☁️ ${prefix}stickerlist
 > ☁️ ${prefix}addimage <reply image with name>
...
> ☁️ ${prefix}reminder 
> ☁️ ${prefix}listonline
> ☁️ ${prefix}sider reply
> ☁️ ${prefix}antilink on|off
> ☁️ ${prefix}tod
> ☁️ ${prefix}tospam amount
> ☁️ ${prefix}antivirtex on|off
> ☁️ ${prefix}autojoin on|off
> ☁️ ${prefix}kickarea
> ☁️ ${prefix}grouplink
> ☁️ ${prefix}resetlink
> ☁️ ${prefix}group [open/close(button)]
 

 ⬣ 𝙈𝘼𝙆𝙄𝙉𝙂 𝙁𝙀𝘼𝙏𝙐𝙍𝙀𝙎
> ☁️ ${prefix}sticker
> ☁️ ${prefix}swm author|packname
> ☁️ ${prefix}take author|packname
> ☁️ ${prefix}fdeface
> ☁️ ${prefix}emoji
> ☁️ ${prefix}golden text
...
> ☁️ ${prefix}battlefield text|text
> ☁️ ${prefix}googletxt2 text|text
> ☁️ ${prefix}transformer text|text
> ☁️ ${prefix}write text
> ☁️ ${prefix}waifu
...
> ☁️ ${prefix}tourl
 ...
 ⬣ 𝘿𝙊𝙒𝙉𝙇𝙊𝘼𝘿 𝙁𝙀𝘼𝙏𝙐𝙍𝙀𝙎
> ☁️ ${prefix}play query
> ☁️ ${prefix}play2 query
> ☁️ ${prefix}playv2 link
> ☁️ ${prefix}playm2 link
> ☁️ ${prefix}song query
> ☁️ ${prefix}video query
> ☁️ ${prefix}instagram link
> ☁️ ${prefix}twitter
> ☁️ ${prefix}facebook link
> ☁️ ${prefix}tiktok link
> ☁️ ${prefix}tiktokmp3 link
> ☁️ ${prefix}ytmp3 link
> ☁️ ${prefix}ytmp4 link
...
> ☁️ ${prefix}viewonce
> ☁️ ${prefix}hbd
> ☁️ ${prefix}herodetail hero name
> ☁️ ${prefix}herolist hero name
> ☁️ ${prefix}beautycheck @tag
> ☁️ ${prefix}uglycheck @tag
> ☁️ ${prefix}handsomecheck @tag
> ☁️ ${prefix}lesbicheck @tag
> ☁️ ${prefix}character @tag
...
`
sendButLocation(from, `${menu}`,`𝘾 𝙍 𝙀 𝘼 𝙏 𝙀 𝘿  𝘽 𝙔  @${dtod.split("@")[0]}`, {jpegThumbnail:iye}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`credit`,buttonText:{displayText:'THANKS TO'},type:1},{buttonId:`script`,buttonText:{displayText:'SUBSCRIBE'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
...
break
case 'h':
reply('https://chat.whatsapp.com/KouZgmTB7t1EObhjePFrkx')
break
case 'okeyx':
reply('💐🌺🌻WELCOME THE NEW MEMBER WITH SOME FLOWERS🌻🌺💐')
break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               ...
               buttons = [{buttonId: `mygithub`,buttonText:{displayText: 'SUBSCRIBE'},type:1},{buttonId:`iggw`,buttonText:{displayText:'PM ON WHATSAPP'},type:1}]
...
☁️${prefix}𝙞𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢 <𝙪𝙧𝙡>

☁️${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, ` ᴍᴏɴsᴛᴇʀ ʙᴏᴛ`, [
          {
            buttonId: `command`,
            buttonText: {
...
case 'groupmenu':
menu = `シ𝘎𝘳𝘰𝘶𝘱 𝘔𝘦𝘯𝘶︎シ︎
☁️${prefix}grup [3 Button]

☁️${prefix}promote <reply chat member>

☁️${prefix}demote <reply chat member>
...
☁️${prefix}kick <reply/tag member>

☁️${prefix}add <reply/tag member>

☁️${prefix}getbio <reply chat member>

☁️${prefix}getname <reply chat member>

☁️${prefix}reminder <msg/2s>
...
☁️${prefix}autoread gc on / gc off
...
☁️${prefix}mode [2 Button self/public]

☁️${prefix}term <code>

☁️${prefix}eval <code>

☁️${prefix}colongsw [reply sw]
...
☁️${prefix}writeleft text

☁️${prefix}folioleft text

☁️${prefix}folioright text

☁️${prefix}ss link web

☁️${prefix}songlyrics <query>

☁️${prefix}namemeaning <name>
...
☁️${prefix}infoearthquake

☁️${prefix}chat 91|P

☁️${prefix}searchmessage <query>

☁️${prefix}get url

☁️${prefix}githubstalk <query>

☁️${prefix}ytsearch <query>

☁️${prefix}igstalk <query>

☁️${prefix}tiktokstalk <query>
...
☁️${prefix}anime <random>

☁️${prefix}pinterest <query>

☁️${prefix}comic <query>

☁️${prefix}lyrics <query>

☁️${prefix}chara <query>
...
☁️${prefix}𝙨𝙬𝙢 <𝙖𝙪𝙩𝙝𝙤𝙧|𝙥𝙖𝙘𝙠𝙣𝙖𝙢𝙚>

☁️${prefix}𝙩𝙖𝙠𝙚 <𝙖𝙪𝙩𝙝𝙤𝙧|𝙥𝙖𝙘𝙠𝙣𝙖𝙢𝙚>
...
case 'script':
		case 'sc':
		case 'sourcecode':
		xeon.sendMessage(from, { text: "https://youtube.com/c/MONSTER007", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
     ...
     break
        ...
        case "broadcast":  
                   if (!isOwner && !mek.key.fromMe) return reply('only owner can use this feature')    
					...
					buff = await xeon.downloadMediaMessage(encmedia)
					for (let _ of anu) {
						xeon.sendMessage(_.jid, buff, image, {quoted:fakestatus ,caption: `「  * ᴍᴏɴsᴛᴇʀ ʙᴏᴛ BROADCAST* 」\n\n${ini_bc}`})
					}
					reply('```Success Broadcast```')
					} else {
					for (let _ of anu) {
					xeon.sendMessage(_.jid, `* ᴍᴏɴsᴛᴇʀ ʙᴏᴛ BROADCAST*\n${ini_bc}`, text, { contextInfo: { mentionedJid: [sender],"forwardingScore":999,"isForwarded":true},sendEphemeral: true })
					}
					reply('```Success Broadcast```')
					}
					break
...
case 'mygithub':
  reply('https://youtu.be/BNgpIm8PrIk')
					break;
   case 'ss':
      reply(mess.wait)
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Subscribe ${fakeyoi}`,
          "url": "https://youtu.be/BNgpIm8PrIk"
        },
        "index": 0
      }
    ]
...
case 'setprefix':
  ...
  case 'writebook':            
            if (args.length == 0) return reply(`example: ${prefix + command} Akbar`)
            reply(mess.wait)
            teks = args.join(" ")
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:' ᴍᴏɴsᴛᴇʀ ʙᴏᴛ', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, ` ᴍᴏɴsᴛᴇʀ ʙᴏᴛ`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「  ᴍᴏɴsᴛᴇʀ ʙᴏᴛ BROADCASTING 」*\n\n${body.slice(4)}`})
}
...
case 'writelist':
  ...
  🌟 ${prefix}write Akbar
  🌟 ${prefix}folioright Akbar
  🌟 ${prefix}folioleft Akbar
  🌟 ${prefix}writedown Akbar
  🌟 ${prefix}writeleft Akbar`)
  break
case 'folioleft':
if (!c) return reply('Where is the text bro??')
reply(mess.wait)
